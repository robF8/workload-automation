...
then
    sh -c 'cd /data/local/tmp/spec2k6/429.mcf/run/run_base_ref_none.0000 && time ./mcf_base.none inp.in  > mcf.ref.out'$3' 2>  mcf.ref.err'$3''
elif [ $1 = "445.gobmk" ]
then
...
then
    ...
    sh -c 'cd /data/local/tmp/spec2k6/416.gamess/run/run_base_ref_none.0000 && time ./gamess_base.none < triazolium.config  > gamess.ref.triazolium.out'$3' 2>  gamess.ref.triazolium.err'$3''
elif [ $1 = "433.milc"]
then
